...
#-----------------------------------------------------------------------------------------
# Script information
script_name='FP ENVIRONMENT - SYSTEM LIBRARIES GENERIC - UDUNITS'
script_version="1.0.0"
script_date='2022/05/18'

# Define library name, archive and repository
library_clean=true
library_name='udunits'
library_archive_generic='udunits.tar.gz'
library_archive_reference='udunits-2.2.28.tar.gz'
library_archive_address='https://artifacts.unidata.ucar.edu/repository/downloads-udunits/2.2.28/'
...
generic_file_env='fp_system_libs_generic_udunits'
